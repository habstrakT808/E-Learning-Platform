...
$courseImages = [
    ...
    'ai-ml.jpg' => 'https://images.unsplash.com/photo-1677442135136-760c813770c8?q=80&w=800&auto=format&fit=crop',
...
// Kategori dan tipe course dengan gambar yang akan digunakan
$categoryImageMap = [
    ...
    'Artificial Intelligence' => 'ai-ml.jpg',
...
try {
    ...
    foreach ($courses as $course) {
        // Tentukan gambar berdasarkan kategori atau gunakan default secara bergilir
        $category = DB::table('categories')->where('id', $course->category_id)->value('name');
        $imageName = $categoryImageMap[$category] ?? array_values($courseImages)[($course->id - 1) % count($courseImages)];
