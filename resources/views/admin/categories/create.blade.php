    ...
    <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="md:flex md:items-center md:justify-between mb-6">
            <div class="flex-1 min-w-0">
                ...
                <p class="mt-1 text-sm text-gray-600">Create a new category or subcategory for your courses</p>
            </div>
            ...
            <form action="{{ route('admin.categories.store') }}" method="POST" class="p-6">
                ...
                <div class="space-y-6">
                    ...
                    <div>
                        ...
                        <div class="mt-1">
                            <input type="text" name="name" id="name" class="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 block w-full sm:text-sm border-gray-300 rounded-md" placeholder="e.g. Web Development" value="{{ old('name') }}" required>
                        </div>
                    ...
                    <div>
                        ...
                        <p class="mt-1 text-xs text-gray-500">Leave empty to create a top-level category or select a parent to create a subcategory.</p>
                    </div>
                    ...
                    <div>
                        ...
                        <div class="mt-1 flex items-center space-x-3">
                            ...
                            <div class="w-full">
                                <input type="text" name="icon" id="icon" class="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 block w-full sm:text-sm border-gray-300 rounded-md" placeholder="e.g. fas fa-code" value="{{ old('icon') }}">
                            </div>
                        </div>
                    ...
                    <div>
                        ...
                        <div class="mt-1">
                            <textarea id="description" name="description" rows="4" class="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 block w-full sm:text-sm border-gray-300 rounded-md" placeholder="Brief description of this category...">{{ old('description') }}</textarea>
                        </div>
