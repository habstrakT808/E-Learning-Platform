                    ...
                    <div class="bg-white rounded-lg shadow-sm p-6 mb-6 sticky top-20">
                        ...
                        <div class="space-y-2">
                            <a href="{{ route('discussions.index') }}" 
                               class="block px-3 py-2 rounded-md {{ !isset($currentCategory) ? 'bg-primary-50 text-primary-700 font-medium' : 'text-gray-700 hover:bg-gray-50' }}">
                                Semua diskusi
                            </a>
                            @foreach($categories as $cat)
                                <a href="{{ route('discussions.category', $cat->slug) }}" 
                                   class="block px-3 py-2 rounded-md {{ isset($currentCategory) && $currentCategory->id == $cat->id ? 'bg-primary-50 text-primary-700 font-medium' : 'text-gray-700 hover:bg-gray-50' }}">
                ...
                <div class="lg:col-span-3">
                    ...
                    <div class="bg-white p-4 rounded-lg shadow-sm border border-gray-100 mb-5">
                        <div class="flex flex-wrap items-center justify-between">
                            ...
                            @auth
                                <a href="{{ route('discussions.create', ['category_id' => $category->id]) }}" class="sm:hidden bg-primary-600 hover:bg-primary-700 text-white py-1.5 px-3 rounded-md text-sm inline-flex items-center justify-center transition-colors duration-200 mt-3 sm:mt-0 w-full sm:w-auto">
                    ...
                    <div class="space-y-4">
                        ...
                        @empty
                            <div class="bg-white p-8 rounded-lg shadow-sm border border-gray-200 text-center">
                                ...
                                <h3 class="text-lg font-medium text-gray-900 mb-1">Belum ada diskusi di kategori ini</h3>
                                <p class="text-gray-500 mb-6">Jadilah yang pertama memulai diskusi di kategori {{ $category->name }}!</p>
                                
                                @auth
                                    <a href="{{ route('discussions.create', ['category_id' => $category->id]) }}" class="bg-primary-600 hover:bg-primary-700 text-white py-2 px-6 rounded-md font-medium inline-flex items-center transition-colors duration-200">
                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-5 h-5 mr-2">
                                            <path stroke-linecap="round" stroke-linejoin="round" d="M12 4.5v15m7.5-7.5h-15" />
                                        </svg>
                                        Mulai Diskusi
