    ...
    <div class="bg-gradient-to-r from-blue-600 to-indigo-700 py-8 text-white">
        <div class="container mx-auto px-4">
            <div class="max-w-7xl mx-auto">
                    ...
                    <ol class="inline-flex items-center space-x-1 md:space-x-3">
                        ...
                        <li>
                            <div class="flex items-center">
                                ...
                                <a href="{{ route('discussions.show', $reply->discussion->slug) }}" class="ml-1 md:ml-2 text-white hover:text-indigo-200">
                                    {{ \Illuminate\Support\Str::limit($reply->discussion->title, 30) }}
                                </a>
                            </div>
                        </li>
                    </ol>
                ...
                <h1 class="text-3xl font-bold mb-2">Edit Balasan</h1>
            </div>
        </div>
    </div>
    ...
    <div class="container mx-auto px-4 py-8">
        <div class="max-w-4xl mx-auto">
            <div class="bg-white rounded-lg shadow-sm p-6">
                <form action="{{ route('discussions.replies.update', $reply->id) }}" method="POST">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="flex justify-end space-x-3">
                        <a href="{{ route('discussions.show', $reply->discussion->slug) }}" class="inline-flex items-center px-4 py-2 border border-gray-300 shadow-sm text-sm font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50 focus:outline-none">
                            Batal
                        </a>
