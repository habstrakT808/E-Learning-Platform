...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links.C:\laragon\www\elearning-platform\public\storage' => 'string',
...
'filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links.C:\\laragon\\www\\elearning-platform\\public\\storage','logging.default','logging.deprecations.channel',
...
'debugbar.queries.explain','home','about','contact',
'search','courses.index','courses.show','courses.category','courses.instructor',
'profile.edit','profile.update','profile.destroy','courses.enroll','courses.unenroll',
'lessons.show','lessons.complete','lessons.watch-time','student.dashboard','student.courses.index',
'student.courses.show','instructor.dashboard','instructor.courses.index','instructor.courses.create','instructor.courses.store',
'instructor.courses.show','instructor.courses.edit','instructor.courses.update','instructor.courses.destroy','instructor.courses.publish',
'instructor.courses.unpublish','instructor.students.index','instructor.students.show','admin.dashboard','admin.users.index',
...
'admin.courses.edit','admin.courses.update','admin.courses.destroy','admin.categories.index','admin.categories.create',
